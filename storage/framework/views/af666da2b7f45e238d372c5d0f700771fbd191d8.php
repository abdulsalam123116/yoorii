...
<?php $__env->startSection('seller-product'); ?>
    active
    ...
    <section class="section">
        <div class="section-body">
            <div class="d-flex justify-content-between">
                <div class="d-block">
                    <h2 class="section-title"><?php echo e(__('Seller Products')); ?></h2>
                    <p class="section-lead">
                        <?php echo e(__('You have total') . ' ' . $products->total() . ' ' . __('Products')); ?>
                ...
                <?php if(hasPermission('product_create')): ?>
                    <div class="buttons add-button">
                        ...
                        <div class="dropdown-menu" x-placement="bottom-start"
                            ...
                            <?php if(addon_is_activated('wholesale') == true): ?>
                                <a class="dropdown-item has-icon" href="<?php echo e(route('wholesale.product.create')); ?>"><i
                                        class='bx bx-plus'></i><?php echo e(__("Add Wholesale Product")); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endif; ?>
                                ...
                                <ul class="nav nav-pills">
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo e($status === null  ? 'active' : ''); ?>"
                                           href="<?php echo e(route('admin.seller.products')); ?>"><?php echo e(__('All')); ?> <span
                                                class="badge badge-primary"><?php echo e($total - $trash); ?></span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo e($status === 'published' && $status != 'trash' ? 'active' : ''); ?>"
                                           href="<?php echo e(route('admin.seller.products','published')); ?>"><?php echo e(__('Published')); ?>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo e($status === 'unpublished' && $status != 'trash' ? 'active' : ''); ?>"
                                           href="<?php echo e(route('admin.seller.products','unpublished')); ?>"><?php echo e(__('Unpublished')); ?>

                                            <span class="badge badge-primary"><?php echo e($unpublished); ?></span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo e($status === 'pending' && $status != 'trash'? 'active' : ''); ?>"
                                           href="<?php echo e(route('admin.seller.products','pending')); ?>"><?php echo e(__('Pending')); ?> <span
                                                class="badge badge-primary"><?php echo e($pending); ?></span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo e($status === 'trash' ? 'active' : ''); ?>"
                                           href="<?php echo e(route('admin.seller.products','trash')); ?>"><?php echo e(__('Trash')); ?> <span
                                    ...
                                    <?php if(settingHelper('seller_system') == 1): ?>
                                        <div class="form-group">
                                            <select class="seller-by-ajax form-control select2" name="sl" id ="seller_id"  aria-hidden="true" >
                                                <?php if(isset($sl)): ?>
                                                    <option selected value="<?php echo e($selected_seller->id); ?>"> <?php echo e($selected_seller->shop_name); ?> </option>
                                                <?php endif; ?>
                                            </select>
                                        </div>
                                    <?php endif; ?>
                                    <div class="form-group">
                                        ...
                                        <select class="filter-categories-by-ajax form-control select2" name="c" id="c">
                                            ...
                                            <?php if(isset($c)): ?>
                                                ...
                                                <option selected value="<?php echo e(@$c); ?>"> <?php echo e($position.@$selected_category->getTranslation('title', App::getLocale())); ?> </option>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                ...
                                <table class="table table-striped table-md">
                                    ...
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr id="row_<?php echo e($product->id); ?>">
                                            ...
                                            <td>
                                                <?php if(@$product->user->user_type != 'seller'): ?>
                                                    <?php echo e(__("admin")); ?>

                                                <?php else: ?>
                                                    <?php if(isset($product->sellerProfile)): ?>
                                                        <br><?php echo e($product->sellerProfile->shop_name); ?>

                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <span><?php echo e(__('Price').': '.get_price($product->price,user_curr())); ?> / <?php echo e($product->getTranslation('unit', \App::getLocale())); ?></span><br>
                                                <span><?php echo e(__('Total Sale').': '.$product->total_sale); ?></span><br>
                                                <span><?php echo e(__('Rating').': '.$product->rating); ?></span><br>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <label class="custom-switch mt-2 <?php echo e((hasPermission('product_update') && $product->status != 'trash' ) ? '' : 'cursor-not-allowed'); ?>">
                                                        <input type="checkbox"
                                                               <?php if(hasPermission('product_update') && $product->status != 'trash'): ?>
                                                                value="product-status-change/<?php echo e($product->id); ?>/status"
                                                               <?php endif; ?>
                                                               <?php echo e($product->status == 'published' ? 'checked' : ''); ?> name="custom-switch-checkbox"
                                                               <?php echo e(hasPermission('product_update') ? '' : 'disabled'); ?>

                                                               class="<?php echo e(hasPermission('produt_update') ? 'product-status-change' : ''); ?> custom-switch-input">
                                            ...
                                            <td>
                                                <label class="custom-switch mt-2 <?php echo e((hasPermission('product_update') && $product->status != 'trash') ? '' : 'cursor-not-allowed'); ?>">
                                                    <input type="checkbox"
                                                           <?php if(hasPermission('product_update') && $product->status != 'trash'): ?>
                                                            value="product-status-change/<?php echo e($product->id); ?>/is_catalog"
                                                           <?php endif; ?>
                                            ...
                                            <td>
                                                <label class="custom-switch mt-2 <?php echo e((hasPermission('product_update') && $product->status != 'trash') ? '' : 'cursor-not-allowed'); ?>">
                                                    <input type="checkbox"
                                                           <?php if(hasPermission('product_update') && $product->status != 'trash'): ?>
                                                            value="product-status-change/<?php echo e($product->id); ?>/todays_deal"
                                                           <?php endif; ?>
                                            ...
                                            <td>
                                                <label class="custom-switch mt-2 <?php echo e((hasPermission('product_update') && $product->status != 'trash') ? '' : 'cursor-not-allowed'); ?>">
                                                    <input type="checkbox"
                                                           <?php if(hasPermission('product_update') && $product->status != 'trash'): ?>
                                                            value="product-status-change/<?php echo e($product->id); ?>/is_featured"
                                                           <?php endif; ?>
                                                        ...
                                                        <?php if(hasPermission('product_update')): ?>
                                                            <?php if($product->is_approved == 1): ?>
                                                                <a href="<?php echo e(route('product.status.change', ['status'=>'pending','id'=>$product->id])); ?>"
                                                                   class="dropdown-item has-icon"><i
                                                                        class='bx bx-block'></i><?php echo e(__('Pending')); ?></a>
                                                            <?php else: ?>
                                                                <a href="<?php echo e(route('product.status.change', ['status'=>'published','id'=>$product->id])); ?>"
                                                                   class="dropdown-item has-icon"><i
                                                                        class='bx bx-check-shield'></i><?php echo e(__('Published')); ?>

                                                                </a>
                                                                <a href="<?php echo e(route('product.status.change', ['status'=>'unpublished','id'=>$product->id])); ?>"
                                                                   class="dropdown-item has-icon"><i
                                                                        class='bx bx-shield-x'></i><?php echo e(__('Unpublished')); ?>
...
<?php echo $__env->make('admin.partials.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\raqmi plus\yoori\ass\resources\views/admin/products/products/seller-products.blade.php ENDPATH**/ ?>