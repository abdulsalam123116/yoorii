<div class="modal" id="clone_menu">
    <div class="menu-item" data-id="1">
        ...
        <label class="sr-only" for="link"><?php echo e(__('Link')); ?></label>
...
<?php /**PATH E:\raqmi plus\yoori\ass\resources\views/admin/store-front/content-append.blade.php ENDPATH**/ ?>