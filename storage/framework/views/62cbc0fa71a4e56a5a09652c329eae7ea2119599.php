            ...
            <div class="row">
                    ...
                    <div class="card payment_method">
                        <div class="card-body">
                            <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php echo e(old('payment_method')  == 'network' ? 'active' : ''); ?>"
                                       id="network-tab" data-toggle="tab" href="#network" role="tab"
                                       aria-controls="network" aria-selected="false"><?php echo e(__('Network')); ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-8 col-lg-9">
                    <div class="tab-content no-padding" id="myTab2Content">
                        <div class="tab-pane fade <?php echo e(old('payment_method') == '' || old('payment_method') == 'network' ? 'show active' : ''); ?>"
                            id="network" role="tabpane1" aria-labelledby="network-tab">
                            <div class="card">
                                <div class="card-header">
                                    <h4><?php echo e(__('Network Setting')); ?></h4>
                                </div>
                                <div class="card-body col-md-10 middle">
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        ...
                                                        <input type="checkbox"
                                                               ...
                                                               value="admin-payment-status-change/<?php echo e('is_network_activated'); ?>"
                                                               <?php echo e(hasPermission('payment_gateway_update') ? '' : 'disabled'); ?>

                                                               class="<?php echo e(hasPermission('payment_gateway_update') ? 'status-change' : ''); ?> custom-switch-input " <?php echo e(settingHelper('is_network_activated') == 1 ? 'checked' : ''); ?> />
                                    ...
                                    <?php if(hasPermission('payment_gateway_update')): ?>
                                        <form action="<?php echo e(route('payment.gateway.update')); ?>" method="post" enctype="multipart/form-data">
                                        <?php echo method_field('put'); ?>
                                        <?php echo csrf_field(); ?>
                                    <?php endif; ?>
                                    <div class="form-group">
                                        <label for="network_token"><?php echo e(__('Token')); ?></label>
                                        <input type="hidden" name="payment_method" value="network">
                                        <input type="text" class="form-control" name="network_token"
                                                id="network_token"
                                                value="<?php echo e(old('network_token') ? old('network_token') : settingHelper('network_token')); ?>"
                                                placeholder="<?php echo e(__('Network Token')); ?>">
                                        <?php if($errors->has('network_token')): ?>
                                            <div class="invalid-feedback">
                                                <?php echo e($errors->first('network_token')); ?>
...
<?php echo $__env->make('admin.partials.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\raqmi plus\yoori\ass\resources\views/admin/settings/payment-gateway/index.blade.php ENDPATH**/ ?>