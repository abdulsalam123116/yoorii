                                        ...
                                        <div class="card-body">
                                            <div class="form-group row mt-2">
                                                ...
                                                <div class="col-md-7">
                                                    <label class="custom-switch">
                                                        <input type="checkbox"
                                                               {{ @$cod->status == 1 ? 'checked' : '' }} value="active-method-status-change/{{@$cod->id}}/is_cod_active"
                                                               name="active_account"
                                                               class="custom-switch-input account-active-status-change">
                                                        <span class="custom-switch-indicator"></span>
                                                    </label>
                                            ...
                                            <div class="form-group row mt-2">
                                                <label
                                                    class="col-md-5 col-from-label">{{ __('Default Account') }}</label>
                                                <div class="col-md-7">
                                                    <label class="custom-switch {{ @$cod->is_default == 1 ? 'cursor-not-allowed' : '' }}">
                                                        <input type="checkbox"
                                                               {{ @$cod->is_default == 1 ? 'checked' : '' }} value="default-status-change/{{@$cod->id}}"
                                                               name="bank_payment"
                                                               class="custom-switch-input {{ @$cod->is_default == 1 ? '' : 'status-change' }}" {{ @$cod->is_default == 1 ? 'disabled' : '' }}>
                                                        <span class="custom-switch-indicator"></span>
                                                    </label>
                                                </div>
                                            </div>
