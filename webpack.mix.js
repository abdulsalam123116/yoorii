...
], 'frontend/css/app.css').combine([
    js_plugin + 'html5shiv.min.js',
    js_plugin + 'respond.min.js',
], 'frontend/js/plugin.js').webpackConfig({
    output: {
        chunkFilename: "frontend/js/chunks-160/[name].[chunkhash].js",
        publicPath: 'auto',
...
mix.js('resources/js/admin.js', 'admin/js/app.js').vue();
